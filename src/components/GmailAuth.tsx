...
const CLIENT_ID: string = process.env.BUN_PUBLIC_CLIENT_ID;
const DISCOVERY_DOC = process.env.BUN_PUBLIC_DISCOVERY_DOC;
const SCOPES = process.env.BUN_PUBLIC_SCOPES;
