...
export function TermsAndConditions() {
  return (
    <div className="w-1/2 flex flex-col mx-auto prose text-center">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Latitud 58, 7130 HENRY E. BROWN, IR. ELVD.
            GOOSE.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Latitud 58, accessible from{" "}
            <a
              href="https://latitud58.net"
      ...
      <ul>
        <li>
          <p>By email: info@latitud58.net</p>
        </li>
        <li>
          <p>
